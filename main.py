...
def main():
    ...
    while True:
        ...
        ext = downsample_images(input_dir, output_dir_downsampled, image_list)
        # TODO could integrate a list of files that are downsampled in while loop considering tracks
        ...
        if len(image_tracks) == 1:  # TODO and number of images are > XX
